...
if("TRUE" STREQUAL "TRUE")
  set(fetch_navigation_SOURCE_PREFIX /mnt/f/ROS/fetch_ros_package/src/fetch_navigation)
  set(fetch_navigation_DEVEL_PREFIX /mnt/f/ROS/fetch_ros_package/devel)
  ...
  set(fetch_navigation_INSTALL_PREFIX /mnt/f/ROS/fetch_ros_package/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fetch_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/f/ROS/fetch_ros_package/src/fetch_navigation/${idir}'.  ${_report}")
    endif()
