...
echo_and_run cd "/home/local/ASUAD/jnagpal1/git/fetch_ros/src/fetch_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/local/ASUAD/jnagpal1/git/fetch_ros/src/fetch_calibration/setup.py" \
     \
    build --build-base "/home/local/ASUAD/jnagpal1/git/fetch_ros/build/fetch_calibration" \
    install \
    --root="${DESTDIR-/}" \
